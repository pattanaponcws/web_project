  ...
  return (
    <div class="p-9 w-screen h-screen bg-base bg-cover  ">
          ...
          if (data.length==0)
            ...
            return(
              <div className="flex justify-center flex-col bg-amber-100 rounded-2xl font-semibold">
                ...
                <div className=" ">
                  <div class="divide-y-2 divide-dashed divide-black">
                    {
                    ...
                    <div className=" flex flex-col md:flex-row justify-between mx-10  p-1 text-sm sm:text-lg">
      ...
      <div className="flex justify-center pt-5">
        <button
          type="button"
          class=" py-2 px-5 bg-amber-100 hover:bg-orange-600 hover:text-amber-100  focus:ring-orange-600 focus:ring-offset-amber-200  text-orange-600  transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg"
        >
